...
```
Для реализации задачи, получения максимальной производительности не взирая на надёжность, отключаем параметры, отвечающие за синхронизацию данных на файловой системе(synchronous_commit,fsync,full_page_writes).  
