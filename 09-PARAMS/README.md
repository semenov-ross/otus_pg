...
Создаём новый кластер PostgresSQL 14, используя в GCE инстансе standard disk, для более наглядной демонстрации влияния конфигурационных параметров сервера PostgresSQL на производительность:
```console
