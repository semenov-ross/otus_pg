...
```
По результатм тестирования можно сделать вывод, что скорость загрузки данных в БД PostgreSQL из файла csv оказалось существено меньше чем в БД MySQL, а скорость выполнения запросов, 
